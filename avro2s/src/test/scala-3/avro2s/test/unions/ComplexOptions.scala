...
case class ComplexOptions(
      ...
      case 0 =>
        {
          ...
          _map_of_option_of_record.foreach { kvp =>
            ...
            val value = {
              kvp._2 match {
                case Some(x: avro2s.test.unions.RecordForComplexOptions) =>
      ...
      case 9 =>
        {
          ...
          _map_of_option_of_fixed.foreach { kvp =>
            ...
            val value = {
              kvp._2 match {
                case Some(x: avro2s.test.unions.FixedForComplexOptions) =>
                  x.asInstanceOf[AnyRef]
                case None =>
                  null.asInstanceOf[AnyRef]
              }
      ...
      case 10 =>
        {
          ...
          _map_of_option_of_enum.foreach { kvp =>
            ...
            val value = {
              kvp._2 match {
                case Some(x: avro2s.test.unions.EnumForComplexOptions) =>
                  x.asInstanceOf[AnyRef]
                case None =>
                  null.asInstanceOf[AnyRef]
              }
  ...
  override def put(field$ : Int, value: Any): Unit = {
    (field$ : @switch) match {
              ...
              key, {
                value match {
                  ...
                  case x: avro2s.test.unions.RecordForComplexOptions =>
                    Option(x.asInstanceOf[avro2s.test.unions.RecordForComplexOptions])
                  case _ =>
      ...
      case 7 =>
        this._map_of_array_of_option_of_record = {
          val map = value.asInstanceOf[java.util.Map[?, ?]]
          scala.jdk.CollectionConverters.MapHasAsScala(map).asScala.toMap map { kvp =>
            val key = kvp._1.toString
            val value = kvp._2
              ...
              key, {
                value match {
                  ...
                  case x: avro2s.test.unions.FixedForComplexOptions =>
                    Option(x.asInstanceOf[avro2s.test.unions.FixedForComplexOptions])
                  case _ =>
                    throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
                }
              }
              ...
              key, {
                value match {
                  ...
                  case x: avro2s.test.unions.EnumForComplexOptions =>
                    Option(x.asInstanceOf[avro2s.test.unions.EnumForComplexOptions])
                  case _ =>
                    throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
                }
              }
