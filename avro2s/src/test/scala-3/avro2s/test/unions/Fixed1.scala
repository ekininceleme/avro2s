...
case class Fixed1() extends org.apache.avro.specific.SpecificFixed {
  ...
  override def writeExternal(out: java.io.ObjectOutput): Unit = avro2s.test.unions.Fixed1.WRITER$.write(this, org.apache.avro.specific.SpecificData.getEncoder(out))
}
object Fixed1 {
