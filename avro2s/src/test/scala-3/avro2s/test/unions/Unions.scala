    ...
    (field$ : @switch) match {
      ...
      case 5 =>
        _union_of_records match {
          ...
          case Some(x: Boolean) =>
            x.asInstanceOf[AnyRef]
          case Some(x: avro2s.test.unions.Record1) =>
            x.asInstanceOf[AnyRef]
          case Some(x: avro2s.test.unions.Record2) =>
            x.asInstanceOf[AnyRef]
          case None =>
            null.asInstanceOf[AnyRef]
        }
      case 6 =>
        _union_of_enum match {
          ...
          case Some(x: Boolean) =>
            x.asInstanceOf[AnyRef]
          case Some(x: avro2s.test.unions.Enum1) =>
            x.asInstanceOf[AnyRef]
          case None =>
            null.asInstanceOf[AnyRef]
        }
      case 7 =>
        _union_of_fixed match {
          ...
          case Some(x: Boolean) =>
            x.asInstanceOf[AnyRef]
          case Some(x: avro2s.test.unions.Fixed1) =>
            x.asInstanceOf[AnyRef]
          case None =>
            null.asInstanceOf[AnyRef]
        }
      ...
      case 15 =>
        _optional_record match {
          case Some(x: avro2s.test.unions.Record3) =>
            x.asInstanceOf[AnyRef]
          case None =>
            null.asInstanceOf[AnyRef]
        }
      case 16 =>
        _optional_enum match {
          case Some(x: avro2s.test.unions.Enum2) =>
            x.asInstanceOf[AnyRef]
          case None =>
            null.asInstanceOf[AnyRef]
        }
      case 17 =>
        _optional_fixed match {
          case Some(x: avro2s.test.unions.Fixed2) =>
            x.asInstanceOf[AnyRef]
          case None =>
            null.asInstanceOf[AnyRef]
        }
        ...
        this._union_of_records = {
          value match {
            ...
            case x: avro2s.test.unions.Record1 =>
              Option(x.asInstanceOf[String | Long | Boolean | avro2s.test.unions.Record1 | avro2s.test.unions.Record2])
        ...
        this._union_of_enum = {
          value match {
            ...
            case x: avro2s.test.unions.Enum1 =>
              Option(x.asInstanceOf[String | Long | Boolean | avro2s.test.unions.Enum1])
            case null =>
              None
            case _ =>
              throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        ...
        this._union_of_fixed = {
          value match {
            ...
            case x: avro2s.test.unions.Fixed1 =>
              Option(x.asInstanceOf[String | Long | Boolean | avro2s.test.unions.Fixed1])
            case null =>
              None
            case _ =>
              throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
        ...
        this._optional_record = {
          value match {
            ...
            case x: avro2s.test.unions.Record3 =>
              Option(x.asInstanceOf[avro2s.test.unions.Record3])
            case _ =>
              throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
          }
        }
        ...
        this._optional_enum = {
          value match {
            ...
            case x: avro2s.test.unions.Enum2 =>
              Option(x.asInstanceOf[avro2s.test.unions.Enum2])
            case _ =>
              throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
          }
        }
        ...
        this._optional_fixed = {
          value match {
            ...
            case x: avro2s.test.unions.Fixed2 =>
              Option(x.asInstanceOf[avro2s.test.unions.Fixed2])
            case _ =>
              throw new org.apache.avro.AvroRuntimeException("Unexpected type: " + value.getClass.getName)
          }
        }
