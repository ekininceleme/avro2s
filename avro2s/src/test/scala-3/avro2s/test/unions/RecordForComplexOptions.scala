...
object RecordForComplexOptions {
  @scala.annotation.static val SCHEMA$: org.apache.avro.Schema = new org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"RecordForComplexOptions","namespace":"avro2s.test.unions","fields":[{"name":"field1","type":"string"}]}""")
}