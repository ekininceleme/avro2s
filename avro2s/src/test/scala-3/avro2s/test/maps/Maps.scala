...
case class Maps(
    ...
    var _map_of_union: Map[String, String | Int],
    var _map_of_union_of_map_of_union: Map[String, Option[String | Long | Boolean | Map[String, Map[String, Option[String | Long | Boolean | Double]]]]],
    var _map_of_arrays: Map[String, List[String]],
    var _map_of_arrays_of_maps: Map[String, List[Map[String, Boolean]]],
    var _map_of_map_of_union: Map[String, Map[String, Option[String | Long | Boolean | Double]]],
    ...
    var _map_of_union_of_record: Map[String, Option[avro2s.test.maps.Record | Int]],
    ...
    var _map_of_union_of_array: Map[String, Option[List[String] | Int]]
      ...
      case 10 =>
        {
          ...
          _map_of_union_of_record.foreach { kvp =>
            ...
            val value = {
              kvp._2 match {
                case Some(x: avro2s.test.maps.Record) =>
                  x.asInstanceOf[AnyRef]
                case Some(x: Int) =>
                  x.asInstanceOf[AnyRef]
                case None =>
  ...
  override def put(field$ : Int, value: Any): Unit = {
    (field$ : @switch) match {
      ...
      case 2 =>
        this._map_of_union_of_map_of_union = {
          val map = value.asInstanceOf[java.util.Map[?, ?]]
          scala.jdk.CollectionConverters.MapHasAsScala(map).asScala.toMap map { kvp =>
            val key = kvp._1.toString
            val value = kvp._2
              ...
              key, {
                value match {
                  case x: avro2s.test.maps.Record =>
                    Option(x.asInstanceOf[avro2s.test.maps.Record | Int])
                  case x: Int =>
                    Option(x)
                  case null =>
                    None
