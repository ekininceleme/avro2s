...
object EmptyRecord {
  @scala.annotation.static val SCHEMA$: org.apache.avro.Schema = new org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"EmptyRecord","namespace":"avro2s.test.records","fields":[]}""")
}