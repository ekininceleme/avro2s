...
object RecordWithNamespaceInheritedFromIndirectParent {
  @scala.annotation.static val SCHEMA$: org.apache.avro.Schema = new org.apache.avro.Schema.Parser().parse("""{"type":"record","name":"RecordWithNamespaceInheritedFromIndirectParent","namespace":"avro2s.test.namespaces","fields":[{"name":"_string","type":"string"}]}""")
}