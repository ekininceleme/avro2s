...
case class ReservedScala3(
  ...
  override def getSchema: Schema = ReservedScala3.SCHEMA$
  override def get(field$ : Int): AnyRef = {
    (field$ : @switch) match {
      ...
      case 41 =>
        `export`.asInstanceOf[AnyRef]
      case 42 =>
        `given`.asInstanceOf[AnyRef]
      case 43 =>
        `then`.asInstanceOf[AnyRef]
      case _ =>
