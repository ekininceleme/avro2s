...
case class Record(var _string: String, var _int: Int) extends SpecificRecordBase {
  def this() = this("", 0)
...
object Record {
  val SCHEMA$ : Schema = new Schema.Parser()
    .parse("{\"type\":\"record\",\"name\":\"Record\",\"namespace\":\"avro2s.test.arrays\",\"fields\":[{\"name\":\"_string\",\"type\":\"string\"},{\"name\":\"_int\",\"type\":\"int\"}]}")
}