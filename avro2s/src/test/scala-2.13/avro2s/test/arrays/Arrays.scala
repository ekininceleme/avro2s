        ...
        _array_of_arrays match {
          case array =>
            scala.jdk.CollectionConverters.BufferHasAsJava({
              array.map {
                array => scala.jdk.CollectionConverters.BufferHasAsJava({
                  array.map {
      ...
      case 7 =>
        _array_of_bytes match {
          case array =>
            scala.jdk.CollectionConverters.BufferHasAsJava({
              array.map {
                bytes => java.nio.ByteBuffer.wrap(bytes)
              }
            }.toBuffer).asJava
        }
      case 8 =>
      ...
      case 3 =>
        this._array_of_records = {
          value match {
            case array: java.util.List[_] =>
              scala.jdk.CollectionConverters.IteratorHasAsScala(array.iterator).asScala.map {
                value => value.asInstanceOf[avro2s.test.arrays.Record]
              }.toList
          }
        }
      case 4 =>
      ...
      case 5 =>
        this._array_of_enums = {
          value match {
            case array: java.util.List[_] =>
              scala.jdk.CollectionConverters.IteratorHasAsScala(array.iterator).asScala.map {
                value => value.asInstanceOf[avro2s.test.arrays.Enum]
              }.toList
          }
        }
      case 6 =>
        this._array_of_fixed = {
          value match {
            case array: java.util.List[_] =>
              scala.jdk.CollectionConverters.IteratorHasAsScala(array.iterator).asScala.map {
                value => value.asInstanceOf[avro2s.test.arrays.Fixed]
              }.toList
          }
        }
      case 7 =>
      ...
      case 11 =>
        this._array_of_floats = {
          value match {
            case array: java.util.List[_] =>
              scala.jdk.CollectionConverters.IteratorHasAsScala(array.iterator).asScala.map {
                value => value.asInstanceOf[Float]
              }.toList
          }
        }
      case 12 =>
