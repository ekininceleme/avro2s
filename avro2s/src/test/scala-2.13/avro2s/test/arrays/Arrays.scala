...
case class Arrays(
    ...
    var _array_of_unions: List[String :+: Int :+: CNil],
    var _array_of_records: List[avro2s.test.arrays.Record],
    var _array_of_union_of_records: List[avro2s.test.arrays.Record1 :+: avro2s.test.arrays.Record2 :+: Int :+: CNil],
                ...
                .map { value =>
                  value match {
                    case x: avro2s.test.arrays.Record1 =>
                      Coproduct[avro2s.test.arrays.Record1 :+: avro2s.test.arrays.Record2 :+: Int :+: CNil](x)
                ...
                .map { value =>
                  value match {
                    case x: avro2s.test.arrays.RecordA =>
                      Coproduct[avro2s.test.arrays.RecordA :+: avro2s.test.arrays.RecordB :+: CNil](x)
                ...
                .map { value =>
                  value match {
                    case x: avro2s.test.arrays.EnumA =>
                      Coproduct[avro2s.test.arrays.EnumA :+: avro2s.test.arrays.EnumB :+: CNil](x)
                ...
                .map { value =>
                  value match {
                    case x: avro2s.test.arrays.FixedA =>
                      Coproduct[avro2s.test.arrays.FixedA :+: avro2s.test.arrays.FixedB :+: CNil](x)
