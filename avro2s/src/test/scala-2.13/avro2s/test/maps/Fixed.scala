...
case class Fixed() extends org.apache.avro.specific.SpecificFixed {
  ...
  override def writeExternal(out: java.io.ObjectOutput): Unit = avro2s.test.maps.Fixed.WRITER$.write(this, org.apache.avro.specific.SpecificData.getEncoder(out))
}
object Fixed {
