...
case class AvroSpec(var _null: scala.Null, var _boolean: Boolean, var _int: Int, var _long: Long, var _float: Float, var _double: Double, var _bytes: Array[Byte], var _string: String, var _enum: avro2s.test.spec.Suit, var _array: List[String], var _map: Map[String, Long], var _union_nullable: Option[String], var _union_other: String :+: Int :+: CNil, var _fixed: avro2s.test.spec.md5) extends org.apache.avro.specific.SpecificRecordBase {
  ...
  override def get(field$: Int): AnyRef = {
    (field$: @switch) match {
      ...
      case 1 =>
        _boolean.asInstanceOf[AnyRef]
      case 2 =>
        _int.asInstanceOf[AnyRef]
      case 3 =>
        _long.asInstanceOf[AnyRef]
      case 4 =>
        _float.asInstanceOf[AnyRef]
      case 5 =>
        _double.asInstanceOf[AnyRef]
      case 6 =>
        java.nio.ByteBuffer.wrap(_bytes).asInstanceOf[AnyRef]
      case 7 =>
        _string.asInstanceOf[AnyRef]
      case 8 =>
        _enum.asInstanceOf[AnyRef]
      case 9 =>
        _array match {
          case array =>
  ...
  override def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      ...
      case 1 =>
        this._boolean = value.asInstanceOf[Boolean]
      case 2 =>
        this._int = value.asInstanceOf[Int]
      case 3 =>
        this._long = value.asInstanceOf[Long]
      case 4 =>
        this._float = value.asInstanceOf[Float]
      case 5 =>
        this._double = value.asInstanceOf[Double]
      case 6 =>
        this._bytes = {
          value match {
      ...
      case 8 =>
        this._enum = value.asInstanceOf[avro2s.test.spec.Suit]
      case 9 =>
        this._array = {
          value match {
      ...
      case 13 =>
        this._fixed = value.asInstanceOf[avro2s.test.spec.md5]
      case _ =>
        throw new org.apache.avro.AvroRuntimeException("Bad index")
    }
  }
