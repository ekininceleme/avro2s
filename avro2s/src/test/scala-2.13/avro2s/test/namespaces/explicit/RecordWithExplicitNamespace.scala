...
case class RecordWithExplicitNamespace(var _string: String, var _record_with_namespace_inherited_from_direct_parent: avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromDirectParent, var _array_of_records: List[avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaArray], var _map_of_records: Map[String, avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaMap], var _union_of_records: avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaUnion :+: String :+: CNil) extends org.apache.avro.specific.SpecificRecordBase {
  def this() = this("", new avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromDirectParent(), List.empty, Map.empty, Inl(new avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaUnion()))
  ...
  override def get(field$: Int): AnyRef = {
    (field$: @switch) match {
      ...
      case 1 =>
        _record_with_namespace_inherited_from_direct_parent.asInstanceOf[AnyRef]
      case 2 =>
  ...
  override def put(field$: Int, value: Any): Unit = {
    (field$: @switch) match {
      ...
      case 1 =>
        this._record_with_namespace_inherited_from_direct_parent = value.asInstanceOf[avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedFromDirectParent]
      case 2 =>
        this._array_of_records = {
          value match {
            case array: java.util.List[_] =>
              scala.jdk.CollectionConverters.IteratorHasAsScala(array.iterator).asScala.map {
                value => value.asInstanceOf[avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaArray]
              }.toList
          }
        }
      case 3 =>
        this._map_of_records = {
          value match {
      ...
      case 4 =>
        this._union_of_records = {
          value match {
            case x: avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaUnion =>
              Coproduct[avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaUnion :+: String :+: CNil](x)
            case x: org.apache.avro.util.Utf8 =>
              Coproduct[avro2s.test.namespaces.explicit.RecordWithNamespaceInheritedViaUnion :+: String :+: CNil](x.toString)
            case _ =>
