...
case class RecordWithNamespaceInheritedViaMap(var _string: String) extends SpecificRecordBase {
  def this() = this("")
  override def getSchema: Schema = RecordWithNamespaceInheritedViaMap.SCHEMA$
...
object RecordWithNamespaceInheritedViaMap {
  val SCHEMA$ : Schema = new Schema.Parser()
    .parse("{\"type\":\"record\",\"name\":\"RecordWithNamespaceInheritedViaMap\",\"namespace\":\"avro2s.test.namespaces.explicit\",\"fields\":[{\"name\":\"_string\",\"type\":\"string\"}]}")
}