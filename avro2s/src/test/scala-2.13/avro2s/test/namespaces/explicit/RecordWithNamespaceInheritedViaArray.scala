...
case class RecordWithNamespaceInheritedViaArray(var _string: String) extends SpecificRecordBase {
  def this() = this("")
  override def getSchema: Schema = RecordWithNamespaceInheritedViaArray.SCHEMA$
...
object RecordWithNamespaceInheritedViaArray {
  val SCHEMA$ : Schema = new Schema.Parser()
    .parse("{\"type\":\"record\",\"name\":\"RecordWithNamespaceInheritedViaArray\",\"namespace\":\"avro2s.test.namespaces.explicit\",\"fields\":[{\"name\":\"_string\",\"type\":\"string\"}]}")
}