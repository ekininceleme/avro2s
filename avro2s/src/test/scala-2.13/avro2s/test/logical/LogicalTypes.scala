...
case class LogicalTypes(
  ...
  override def put(field$ : Int, value: Any): Unit = {
    (field$ : @switch) match {
      ...
      case 1 =>
        this._date = value.asInstanceOf[java.time.LocalDate]
      case 2 =>
        this._time_millis = value.asInstanceOf[java.time.LocalTime]
      case 3 =>
        this._time_micros = value.asInstanceOf[java.time.LocalTime]
      case 4 =>
        this._timestamp_millis = value.asInstanceOf[java.time.Instant]
      case 5 =>
        this._timestamp_micros = value.asInstanceOf[java.time.Instant]
      case 6 =>
        this._local_timestamp_millis = value.asInstanceOf[java.time.LocalDateTime]
      case 7 =>
        this._local_timestamp_micros = value.asInstanceOf[java.time.LocalDateTime]
      case _ =>
        throw new org.apache.avro.AvroRuntimeException("Bad index")
    }
  }
