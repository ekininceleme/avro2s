...
case class ComplexLogicalTypes(
    ...
    var _array: List[java.time.LocalDate],
    var _union: Int :+: java.time.Instant :+: CNil,
    var _option: Option[java.util.UUID],
    var _option_alt: Option[java.time.LocalDate],
    var _map_union: Map[String, Int :+: java.time.Instant :+: CNil],
    var _map_option: Map[String, Option[java.time.Instant]],
    var _map_array: Map[String, List[java.time.LocalDate]],
    var _union_map: Int :+: Map[String, java.util.UUID] :+: CNil,
    var _union_map_alt: Int :+: Map[String, java.time.LocalDate] :+: CNil,
    var _union_array: Int :+: List[java.time.LocalDate] :+: CNil,
    var _array_map: List[Map[String, java.util.UUID]],
    var _array_map_alt: List[Map[String, java.time.LocalDate]],
    var _array_union: List[Int :+: java.time.Instant :+: CNil],
    ...
    (field$ : @switch) match {
      ...
      case 3 =>
        this._union = {
          value match {
            case x: Int =>
              Coproduct[Int :+: java.time.Instant :+: CNil](x)
      ...
      case 9 =>
        this._union_map = {
          value match {
            case x: Int =>
              Coproduct[Int :+: Map[String, java.util.UUID] :+: CNil](x)
            case map: java.util.Map[_, _] =>
              Coproduct[Int :+: Map[String, java.util.UUID] :+: CNil] {
                scala.jdk.CollectionConverters.MapHasAsScala(map).asScala.toMap map { kvp =>
                  val key = kvp._1.toString
                  val value = kvp._2
                  (
      ...
      case 10 =>
        this._union_map_alt = {
          value match {
            case x: Int =>
              Coproduct[Int :+: Map[String, java.time.LocalDate] :+: CNil](x)
            case map: java.util.Map[_, _] =>
              Coproduct[Int :+: Map[String, java.time.LocalDate] :+: CNil] {
                scala.jdk.CollectionConverters.MapHasAsScala(map).asScala.toMap map { kvp =>
                  val key = kvp._1.toString
                  val value = kvp._2
                  (
      ...
      case 11 =>
        this._union_array = {
          value match {
            case x: Int =>
              Coproduct[Int :+: List[java.time.LocalDate] :+: CNil](x)
            case x: java.util.List[_] =>
              Coproduct[Int :+: List[java.time.LocalDate] :+: CNil]({
                x match {
                  case array: java.util.List[_] =>
                    scala.jdk.CollectionConverters
                      .IteratorHasAsScala(array.iterator)
